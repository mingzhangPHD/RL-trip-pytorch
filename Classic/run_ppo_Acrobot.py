...
def argsparser():
    ...
    parser.add_argument('--env_id', help='environment ID', default='Acrobot-v1')
    ...
    parser.add_argument('--num_steps', help='num steps', type=int, default=1e6)
    parser.add_argument('--max_steps_per_episodes', help='max steps per episodes', type=int, default=1000)
    ...
    parser.add_argument('--stop_condition', help='stop_condition', type=int, default=-60)
    ...
    def evaluate_policy(self, env, model, time_step, max_step, use_device, evaluation_trajectories=6):
        ...
        for _ in range(evaluation_trajectories):
            ...
            while not done:
                ...
                # state = torch.FloatTensor(obs[None])
