...
def argsparser():
    ...
    parser.add_argument('--evaluate_every', help='evaluate every', type=int, default=2001)
    parser.add_argument('--stop_condition', help='stop_condition', type=int, default=70)
